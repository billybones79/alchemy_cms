...
module Alchemy
  module Generators
    class InstallGenerator < ::Rails::Generators::Base
      ...
      def copy_spree_application_layout
        copy_file Rails.root.join('../frontend/app/views/spree/layouts/spree_application.html.erb').to_s, "app/views/layouts/spree_application.html.erb"
      end
